...
$tnx = new TNX_l();
$my_link = "<a href=\"http://yukcariduit.co.cc\" target=\"_blank\">Yuk Cari Duit</a>";
echo "<ul>";
echo "<li>". $my_link. "</li>"; // this is my link
echo "<li>". $tnx->show_link(1). "</li>"; // first link
echo "<li>". $tnx->show_link(1). "</li>"; // second link
echo "<li>". $tnx->show_link(1). "</li>"; // third link
echo "<li>". $tnx->show_link(). "</li>"; // remaining links
echo "</ul>";
/*-->*/
?>